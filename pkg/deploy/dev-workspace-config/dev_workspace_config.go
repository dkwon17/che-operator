...
import (
	...
	// /projects/che-operator/pkg/common/operator-defaults/defaults.go
	defaults "github.com/eclipse-che/che-operator/pkg/common/operator-defaults"
	// /projects/che-operator/controllers/devworkspace/defaults/defaults.go
...
func updateFuseOverlay(enabled bool, ctx *chetypes.DeployContext, workspaceConfig *controllerv1alpha1.WorkspaceConfig) error {
	...
	if !enabled {
		...
		delete(workspaceConfig.Annotations, "io.kubernetes.cri-o.Devices")
	...
	if workspaceConfig.Annotations == nil {
		workspaceConfig.Annotations = map[string]string{}
	}
	workspaceConfig.Annotations["io.kubernetes.cri-o.Devices"] = "/dev/fuse"
