...
func (r *CheClusterReconciler) checkWorkspacePermissions(deployContext *deploy.DeployContext) (bool, error) {
...
func (r *CheClusterReconciler) delegateWorkspacePermissionsInTheSameNamespaceWithChe(deployContext *deploy.DeployContext) (bool, error) {
...
func (r *CheClusterReconciler) removeWorkspacePermissionsInSameNamespaceWithChe(deployContext *deploy.DeployContext) (bool, error) {
